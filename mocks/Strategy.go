...
func (_m *Strategy) Collector(height uint64) (base.Hash, error) {
	ret := _m.Called(height)

	var r0 base.Hash
	if rf, ok := ret.Get(0).(func(uint64) base.Hash); ok {
		r0 = rf(height)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Strategy) Leader(height uint64) (base.Hash, error) {
	ret := _m.Called(height)
